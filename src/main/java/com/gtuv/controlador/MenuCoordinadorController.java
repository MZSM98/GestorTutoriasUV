...
public class MenuCoordinadorController implements Initializable {
    ...
    private void configurarUsuario() {
        ...
        if (usuario != null) {
            ...
            lblRol.setText("Coordinador de Tutorías");
        }
    }
    ...
    private void clicTutores(ActionEvent event) {
        abrirVentanaModal("/com/gtuv/vista/FXMLConsultaTutores.fxml", "Consulta de Tutores");
    }

    @FXML
    private void clicTutorias(ActionEvent event) {
        abrirVentanaModal("/com/gtuv/vista/FXMLGestionFechaTutoria.fxml", "Gestión de Fechas de Tutoría");
    }

    @FXML
    private void clicReportes(ActionEvent event) {
        abrirVentanaModal("/com/gtuv/vista/FXMLGestionReporteGeneral.fxml", "Gestión de Reporte General");
    }
